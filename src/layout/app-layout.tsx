...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'document', path: '/documents', entity: 'document', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'excavator', path: '/excavators', entity: 'excavator', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'note', path: '/notes', entity: 'note', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'project', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiHome },
  {
    name: 'user_project',
    path: '/user-projects',
    entity: 'user_project',
